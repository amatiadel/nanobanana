...
import { PromptItem, PromptsResponse } from '@/lib/types';

interface ImagesPageClientProps {
  initialData: PromptsResponse;
}

export function ImagesPageClient({ initialData }: ImagesPageClientProps) {
  const [prompts, setPrompts] = useState<PromptItem[]>(initialData.items);
